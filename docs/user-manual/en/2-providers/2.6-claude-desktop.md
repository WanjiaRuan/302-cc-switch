...
```text
http://127.0.0.1:30221/claude-desktop
```
...
| Status | Description |
|--------|-------------|
| On | Local gateway is running, usually at `127.0.0.1:30221` |
...
~/Library/Application Support/Claude-3p/configLibrary/302cc302-0000-4000-8302-000000030221.json
```
...
%LOCALAPPDATA%\Claude-3p\configLibrary\302cc302-0000-4000-8302-000000030221.json
```
