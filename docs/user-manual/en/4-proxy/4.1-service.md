...
| Listen Port | Port the proxy listens on | `30221` |
...
{
  "env": {
    "ANTHROPIC_BASE_URL": "http://127.0.0.1:30221"
  }
}
```
...
**Codex**:
```toml
base_url = "http://127.0.0.1:30221/v1"
```

**Gemini**:
```
GOOGLE_GEMINI_BASE_URL=http://127.0.0.1:30221
```
